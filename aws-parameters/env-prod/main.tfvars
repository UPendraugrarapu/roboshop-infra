parameters = [
 ...
 { name = "prod.shipping.cart_endpoint", value = "cart-prod.devopsb71.tech:80", type = "String" },
 { name = "prod.shipping.db_host", value = "mysql-prod.devopsb71.tech", type = "String" },
 { name = "prod.payment.cart_host", value = "cart-prod.devopsb71.tech", type = "String" },
 { name = "prod.payment.cart_port", value = "80", type = "String" },
 { name = "prod.payment.user_host", value = "user-prod.devopsb71.tech", type = "String" },
