parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.devopsb71.online:80/", type = "String" },
  { name = "dev.frontend.user_url", value = "http://user-dev.devopsb71.online:80/", type = "String" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.devopsb71.online:80/", type = "String" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.devopsb71.online:80/", type = "String" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.devopsb71.online:80/", type = "String" },
  ...
  { name = "dev.shipping.cart_endpoint", value = "cart-dev.devopsb71.online:80", type = "String" },
